...
public class MyToast {
    ...
    public void toastShow(Builder builder) {
        ...
        if (builder.mGravity == GRAVITY_CENTER) {
            ...
            flexibleToast.setGravity(Gravity.TOP | Gravity.CENTER_VERTICAL, 0, ScreenUtil1.dp2px(mContext, 20));
        } else {
            flexibleToast.setGravity(Gravity.BOTTOM | Gravity.CENTER_VERTICAL, 0, ScreenUtil1.dp2px(mContext, 20));
        }
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            mDefaultView = LayoutInflater.from(context).inflate(R.layout.layout_toast, null);
