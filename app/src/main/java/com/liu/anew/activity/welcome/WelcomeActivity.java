package com.liu.anew.activity.welcome;
...
import com.liu.anew.activity.main.MainActivity;
import com.liu.anew.bean.custom.UpdateInfo;
...
public class WelcomeActivity extends Activity {
            ...
            switch (msg.what) {
                ...
                case DOWNLOAD_VERSION_SUCCESS:
                    ...
                    if (version.equals(updateInfo.version)) {
                        ToastUtils.showLong("当前应用已经是最新版本");
                        toMain();
                    } else {
                ...
                case DOWNLOAD_APK_FAIL:
                    ToastUtils.showLong("联网下载数据失败");
                    toMain();
                    break;
                case DOWNLOAD_APK_SUCCESS:
                    ToastUtils.showLong("下载应用数据成功");
                    dialog.dismiss();
                    installApk();//安装下载好的应用
    ...
    private void updateApkFile() {
        ...
        if (!connect) {//没有移动网络
            ToastUtils.showLong("当前没有移动数据网络");
            toMain();
        } else {//有移动网络
            //联网获取服务器的最新版本数据
